...
class My_SocialNetworksWidget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		$networks['GoogleBuzz']['link'] = $instance['googlebuzz'];
		...
		$networks['GoogleBuzz']['label'] = $instance['googlebuzz_label'];
		...
		?>
			...
			<ul class="social-networks">
					...
					<?php foreach(array("GoogleBuzz", "Vimeo", "Facebook", "Twitter", "Flickr", "Feed", "Linkedin", "Delicious", "Youtube") as $network) : ?>
	...
	function update( $new_instance, $old_instance ) {
		...
		$instance['googlebuzz'] = $new_instance['googlebuzz'];
		...
		$instance['googlebuzz_label'] = $new_instance['googlebuzz_label'];
	...
	function form( $instance ) {
		...
		$googlebuzz = $instance['googlebuzz'];
		...
		$googlebuzz_label = $instance['googlebuzz_label'];
...
?>
	...
	<fieldset style="border:1px solid #dfdfdf; padding:10px 10px 0; margin-bottom:1em;">
			<legend style="padding:0 5px;"><?php _e('Google Buzz'); ?>:</legend>	
		<p><label for="<?php echo $this->get_field_id('googlebuzz'); ?>"><?php _e('Google Buzz URL:'); ?></label>
		<input class="widefat" id="<?php echo $this->get_field_id('twitter'); ?>" name="<?php echo $this->get_field_name('googlebuzz'); ?>" type="text" value="<?php echo esc_attr($googlebuzz); ?>" /></p>
        <p><label for="<?php echo $this->get_field_id('googlebuzz_label'); ?>"><?php _e('Google Buzz label:'); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id('googlebuzz_label'); ?>" name="<?php echo $this->get_field_name('googlebuzz_label'); ?>" type="text" value="<?php echo esc_attr($googlebuzz_label); ?>" /></p>
        </fieldset>
