      ...
      <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        ...
        <?php $post_image_size = of_get_option('post_image_size'); ?>
          ...
          <?php if(has_post_thumbnail()) {
            echo '<figure class="featured-thumbnail"><a href="'; the_permalink(); echo '"><span class="img-wrap"></span>';
            the_post_thumbnail();
            echo '</a></figure>';
            }
          ?>
        <?php } else { ?>
          <?php if(has_post_thumbnail()) {
            echo '<figure class="featured-thumbnail large"><a href="'; the_permalink(); echo '"><span class="img-wrap"></span>';
        ...
        <div class="post-content">
          <?php $post_excerpt = of_get_option('post_excerpt'); ?>
            ...
            <div class="excerpt">
			<?php if($post_image_size=='' || $post_image_size=='normal'){ ?>
		  		<?php $excerpt = get_the_excerpt(); echo my_string_limit_words($excerpt,34);?>
			<?php } else { ?>	
				<?php $excerpt = get_the_excerpt(); echo my_string_limit_words($excerpt,50);?>
			<?php } ?>
		  </div>
          <?php } ?>
