...
function optionsframework_options() {
	...
	$options[] = array( "name" =>  "Body styling",
        ...
        $options[] = array( "name" => "Background image width",
						"desc" => "Background image width in pixels (required)",
						"id" => "body_image_w",
						"std" => "2048",
						"class" => "mini",
						"type" => "text");
        
        $options[] = array( "name" => "Background image height",
						"desc" => "Background image height in pixels (required)",
						"id" => "body_image_h",
						"std" => "1024",
						"class" => "mini",
						"type" => "text");
	...
	$options[] = array( "name" => "Logo URL",
						"desc" => "Enter the direct path to your logo image. For example http://your_website_url_here/wp-content/themes/theme1385/images/logo.png",
						"id" => "logo_url",
						"type" => "upload");
