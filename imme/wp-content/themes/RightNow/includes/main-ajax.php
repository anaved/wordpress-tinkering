...
function check_theme(){
	...
	$re .= addCheckItem( array('name'=>'TimThumb PHP Script', 'status'=>'wait', 'id'=>'timthumbcheck',
		'ErrMessage'=>'ThimThumb image resizer script is not working on your server!', 
		'ErrInfo'=>'This script resizes and crop the images. Without this script, you must edit your images manually.') );
