...
<script type="text/javascript">
	...
	function getImageManager(){
		showMessage('waiting', 'Getting images list...', 'getimages');
		$.post(ajaxurl, {'action':'get_images'}, function(data){
			...
			showMessage('successful', 'Images list has been gotted successfully', 'getimages');
		});	
	}
	function themeCheck(){
		closeImageManager();
			...
			<div id="gallerydetail" style="display:none">
				<div id="addBg">
					...
					<div class="image">
						...
						<script>
						if($.browser.msie || $.browser.webkit)
							document.write('This browser may not support Multi Upload module. Please try another browser like Firefox etc.');
						</script>
					</div>
					<div class="video">
						<form>
...
<div id="imageManager" class="trueWrapper" style="width:340px;">
	<h3 class="trueHeader" style="margin:0">Image Manager</h3>
